# GPU Tests PyTorch and TensorFlow tests for Ubuntu 25.10, Nvidia 5080 

## Summary
This repo has a couple of simple tests to confirm your GPU is being used for 
PyRorch and TensorFlow. The tests were developed with claude.ai.

TensorFlow support for the 5080 is currently in the nightly build only.
